...
[
   ...
   {
      trigger:"exp",
      replacement:"\\exp \\left( $0 \\right) $1",
      options:"mA"
   },
   {
      trigger:"inf",
      replacement:"\\inf_{ $0 }$1",
      options:"mA"
   },
   {
      trigger:"sup",
      replacement:"\\sup_{ $0 }$1",
      options:"mA"
   },
   {
      trigger:"ee",
   ...
   {
      trigger:"cal",
      replacement:"\\mathcal{$0}$1",
      options:"mA"
   },
   {
      trigger:"bb",
      replacement:"\\mathbb{$0}$1",
      options:"mA"
   },
   {
      trigger:"frak",
   ...
   // Handle conflict with"im"snippet
   {
      trigger:"bra",
      replacement:"\\bra{$0} $1",
      options:"mA"
...
https://jsonformatter.curiousconcept.com/# (Uncheck fix JSON box)